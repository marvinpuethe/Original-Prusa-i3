...
union()
{
    ...
    translate([-4,35.5,-25]) cube([22,10,30]);
    translate([-4,68,-12]) rotate([51,0,0]) cube([17,15,11.1]);
    translate([12.5,66.3,-5.8]) rotate([50,0,0])  cylinder(r=6.1,h = 6, $fn=6);
}


translate([12.5,42,1]) rotate([90,0,0])  cylinder(r=1.6,h = 10, $fn=30);
translate([12.5,46.9,1]) rotate([90,0,0])  cylinder(r=3.1,h = 5, $fn=30);

translate([12.5,70,-9]) rotate([50,0,0])  cylinder(r=1.6,h = 15, $fn=60);
translate([12.5,65,-4.8]) rotate([50,0,0])  cylinder(r=3.1,h = 17, $fn=6);
...
translate([-25,86,-9]) rotate([180,0,0]) cube([50,150,20]);
